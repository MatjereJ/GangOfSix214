...
Country::Country(string s, bool o)
{
    cName = s;
    ocean = o;
}
...
void Country::selectWarTheatre()
{
    ...
    cout << "Choose your most Lethal Theatre!! "
         << "Is it:" << endl;
    cout << "A-AirSpace" << endl
         << "B-Land" << endl
         << "C-Sea" << endl;
...
{
    return new CountryBackup(hp, battlestate, warTheatre, Artillery, countryObservers, OpposingCountry, win);
}
...
void Country::reinstateCountry(CountryBackup *backup)
{
    ...
    Artillery = s->getWarParticipants();
...
{
    this->hp = hp - dmg;
    vector<WarParticipant *>::iterator it = Artillery.begin();
    int totalSoldiers = 0;
